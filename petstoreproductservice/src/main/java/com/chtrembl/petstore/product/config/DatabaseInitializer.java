...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        log.info("Database tables not found. Initializing database from productservice.sql...");
        
        try {
            ClassPathResource resource = new ClassPathResource("productservice.sql");
    ...
    private boolean tablesExist() {
        try {
            // Check if the 'product' table exists (as a representative table)
